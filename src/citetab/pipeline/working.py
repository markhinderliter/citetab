...
These are deliberately *not* the canonical :mod:`citetab.models.registry`
...
a single immutable :class:`~citetab.models.registry.CitationRegistry` frozen from
them (see :func:`citetab.pipeline.convergence.freeze_registry`). Keeping the
