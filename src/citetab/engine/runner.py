...
The runner is the one place that turns a :class:`~citetab.pipeline.convergence.
GenerationResult` into findings and a process outcome. It assembles the immutable
:class:`~citetab.rules.base.RuleContext`, validates that the cards and
...
from citetab.engine.rule_loader import load_rule_cards, validate_implementations
from citetab.models.finding import Finding
from citetab.pipeline import convergence, input_toa_diff, parser
