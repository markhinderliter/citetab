...
authority. The toatool recognizer (:mod:`toatool.pipeline.supplemental`) fills
...
The output is a list of mutable :class:`~toatool.pipeline.working.WorkingAuthority`
...
from toatool.pipeline.courts import court_abbreviation
from toatool.pipeline.extractor import BodyText
from toatool.pipeline.parser import ParsedDocument
from toatool.pipeline.supplemental import SupplementalCitation, recognize
