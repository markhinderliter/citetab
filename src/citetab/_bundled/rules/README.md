# citetab Rule Pack — Step C (Rule Specifications)
...
## How citetab rules differ from CallLint rules

CallLint was a linter: rules *were* the product. citetab is a
...
TT-002, TT-003, and TT-004 require citetab to **parse the input
