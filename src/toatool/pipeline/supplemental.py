"""toatool's deterministic citation recognizer — the owned seam over eyecite.
...
and matched against valid Bluebook formats only. The :mod:`toatool.pipeline.resolver`
...
from toatool.models.registry import AuthorityType

#: Recognizer version. This is the toatool-owned seam; bumping it signals a
